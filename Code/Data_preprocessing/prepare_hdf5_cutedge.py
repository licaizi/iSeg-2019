...
data_path = file_paths['src_train_data_path']
# Saved path
target_path = file_paths['src_train_hdf5_path']
...
def build_h5_dataset(data_path, target_path):
    ...
    for i in range(10):
        ...
        with open(file_paths['train_list'], 'a') as f:
...
if __name__ == '__main__':
    ...
    if os.path.exists(file_paths['train_list']):
        os.remove(file_paths['train_list'])
